...
public class OrderTests {
    ...
    void shouldTestPositivResult() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79532695326");
    ...
    void shouldTestPositivResultDoubleSurname() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Римский-Корсаков Семен");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79532695326");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button__text")).click();
        String expected = "  Ваша заявка успешно отправлена! Наш менеджер свяжется с вами в ближайшее время.";
    ...
    void shouldTestPositivResultLongSurname() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Оттовордемгентшенфельд Иосиф");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79532695326");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button__text")).click();
        String expected = "  Ваша заявка успешно отправлена! Наш менеджер свяжется с вами в ближайшее время.";
    ...
    void shouldTestPositivResultShortSurnameName() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Ая Яа");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79532695326");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button__text")).click();
        String expected = "  Ваша заявка успешно отправлена! Наш менеджер свяжется с вами в ближайшее время.";
